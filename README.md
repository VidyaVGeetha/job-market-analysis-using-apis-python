# Job Market Analysis Using APIs and Python

This project analyzes job market data collected through a Flask-based REST API and performs exploratory data analysis to identify trends in skills, job roles, and experience-level demand. The project demonstrates end-to-end data analytics workflow, including API data collection, data wrangling, visualization, and report generation.

## 🎯 Objectives
- Collect job data using a Flask API
- Clean and process the dataset using Python and Pandas
- Identify in-demand skills and technologies
- Analyze job demand by experience level and job roles
- Export insights into a multi-sheet Excel report
...
- Top in-demand skills (Python, SQL, JavaScript, etc.)
- Job demand by experience categories (0–2, 2–5, 5–10+ years)
- Most frequent job roles
- Skill frequency and technology usage patterns

## 🧾 Excel Report Output
The generated report contains multiple sheets:
- Raw_Job_Data
- Skill_Demand
- Experience_Demand
- Top_Job_Titles
...
## 🚀 How to Run
1. Start the Flask API (`Jobs_API.ipynb`)
...
- API-based data collection and analysis
